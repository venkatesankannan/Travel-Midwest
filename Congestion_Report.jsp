...
//alert(expy);
		  ...
		  $.post("./expy_servlet.jsp" ,{'expy': expy},  function (data)  
            {  
				//alert(data);
				 if(data.length >0) {
...
<li>
<a href="Traffic_Illinois.jsp">Congestion Report-Chicago</a>
</li>
</ul>
</div>
    <!-- breadcrumb ends -->
...
<div align="center" style=" width: 1366px;">
...
try {
			...
			String from=null;
			String to=null;
			String myQuery = "SELECT * FROM \"congestionData\" where expressway='I-43'";
