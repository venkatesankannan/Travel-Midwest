...
<head>
    ...
    <!-- The styles -->
    <link rel='shortcut icon' href='charism-master/img/favicon_tm.ico' type='image/x-icon'/ >
...
<div> <p align= "center" style = "color:red;">Error in submitting report. Please enter values for all the fields</p> </div>
</form>
                </div>
