...
if(document.myForm.add.value=="")
 {
  document.getElementById('errmsg').innerHTML = "Please enter your destination address";
  myForm.add.focus();
  return(false);
 }
}
...
<body onload="initialize()">
    ...
    <div class="navbar navbar-default" role="navigation" style="height:60px;">
        ...
        <div class="relative1" style="float:right;">
<div class="side" ><img src="charisma-master/img/rssfeed.png" height="56px" width="52 px">
<div id="rssincl-box-container-991831" class="new">
<script type="text/javascript">
(function() {
